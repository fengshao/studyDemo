(function(a, b) {
	...
	function f(b, c, d, e, f) {
		if (b && c && d) {
			var g, h, i, j, k = b + "://" + c + "/" + d;
			if (e = e || [], !f || !N[f] && !window[f])
				for (f = null, h = 0, i = e.length; i > h; h++)
					if (g = e[h], a.isObject(g) && (g = g.callbackName || g.callback), g && (N[g] || window[g])) {
						f = g;
						break
					}
			f && (O[f] = {
	...
	function k(d, f, g, h) {
		var i, k, l, m = a.isFunction(d) ? d : N[d] || window[d],
			n = Date.now();
		f = f || [], i = f[0], a.isUndefined(h) && (h = !0), a.isObject(i) && ("data" in i || (i.data = c({}, i)), "code" in i || (i.code = j(i) || 0), i.msg = i.msg || ""), a.isFunction(m) ? h ? setTimeout(function() {
			m.apply(null, f)
		}, 0) : m.apply(null, f) : console.log("mqqapi: not found such callback: " + d), g && (delete N[d], delete window["__MQQ_CALLBACK_" + d]), O[d] && (l = O[d], delete O[d], e({
			from: "fireCallback",
			ns: l.ns,
			method: l.method,
	...
	function s(c, d, e, g) {
		...
		var h, j, l, m;
		if (l = F.call(arguments, 2), g = l.length && l[l.length - 1], a.isFunction(g) ? l.pop() : a.isUndefined(g) ? l.pop() : g = null, e = l[0], j = i(g), -1 === U.indexOf(d) && f("jsbridge", c, d, l, j), g && a.isObject(e) && !e.callback && (window["__MQQ_CALLBACK_AUTO_" + j] = g, e.callback = "__MQQ_CALLBACK_AUTO_" + j), q(c, d))
	...
	}()), a.iOS = H.test(D), a.android = I.test(D), a.iOS && a.android && (a.iOS = !1), a.version = "20160628014", a.QQVersion = "0", a.clientVersion = "0", a.ERROR_NO_SUCH_METHOD = "no such method", a.ERROR_PERMISSION_DENIED = "permission denied", a.compare = function(b) {
	...
	iOS: function(a, b) {
		if (a) {
			a && a.name && (b = a, a = a.name), b || (b = {}), b.src_type = b.src_type || "web", b.version = b.version || 1, -1 == a.indexOf("://") && (a += "://");
			var c = a;
	...
	iOS: function(a, b) {
		var c = a.appIDs;
		mqq.data.fetchJson({
			url: "//cgi.connect.qq.com/api/get_openids_by_appids",
			params: {
...
function() {
	...
	mqq.build("mqq.tenpay.pay", {
		iOS: function(b, c) {
			b.order_no = b.tokenId || b.tokenID, b.app_info = b.app_info || b.appInfo, mqq.compare("4.6.2") >= 0 ? mqq.invokeSchema("mqqapi", "wallet", "pay", b, a(c)) : mqq.invokeSchema("mqqapiwallet", "wallet", "pay", b, a(c))
		},
		android: function(b, c) {
			b.token_id = b.tokenId || b.tokenID, b.app_info = b.app_info || b.appInfo, mqq.compare("4.6.1") >= 0 ? mqq.invokeClient("pay", "pay", JSON.stringify(b), c) : mqq.invokeSchema("mqqapi", "tenpay", "pay", b, a(c))
		},
		supportInvoke: !0,
		support: {
			iOS: "4.6.1",
	...
	iOS: function(a) {
		mqq.invokeClient("nav", "openLinkInSafari", {
			url: "//open.mobile.qq.com/sdk/shortcut.ios.html?" + mqq.toQuery(a) + "#from=mqq"
		})
	},
	android: function(a) {
		a.data = {
