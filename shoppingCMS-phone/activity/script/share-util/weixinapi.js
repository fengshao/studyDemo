	...
	Api.init = function(_config) {
		...
		if(window.location.host == 'project.starfruit.net.cn'|| window.location.host == 'project.starfruit.net.cn:8080'){
			...
			$.ajax({  
				...
				//url : "http://wx.t.wesai.com/token/CreateJsApiTicket?url=http://mini.wesai.com/20160928CBA/index_3.html/&callback=?",
				url : "https://wxproxy-t.wesai.com/token.php?url=http://mini.wesai.com/20160928CBA/index_3.html/&wxtype=1&callback=?",
				dataType : "jsonp",
