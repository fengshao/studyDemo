...
var refresher = {
	...
	init: function(parameter) {
		var wrapper1 = document.getElementById(parameter.id);
		var div = document.createElement("div");
		div.className = "scroller";
		wrapper1.appendChild(div);
		var scroller = wrapper1.querySelector(".scroller");
		var list = wrapper1.querySelector("#" + parameter.id + " ul");
		...
		var pullDownEl = wrapper1.querySelector(".pullDown");
		var pullDownOffset = pullDownEl.offsetHeight;
		var pullUpEl = wrapper1.querySelector(".pullUp");
